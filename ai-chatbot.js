...
(function () {
    ...
    function init() {
        ...
        container.innerHTML = `
            <!-- 左下角悬浮客服按钮 (修改了 right-6 为 left-6) -->
            <div id="dify-chat-bubble" class="fixed bottom-6 left-6 bg-blue-600 text-white p-4 rounded-full shadow-lg cursor-pointer hover:bg-blue-700 transition duration-300 z-50">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" />
                </svg>
            </div>

            <!-- 客服对话窗口 (修改了 right-6 为 left-6) -->
            <div id="dify-chat-window" class="hidden fixed bottom-6 left-6 w-80 sm:w-96 h-[500px] bg-white rounded-lg shadow-2xl flex flex-col overflow-hidden border border-gray-100 z-50">
                <!-- 窗口头部 -->
